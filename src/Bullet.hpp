...
public:
  ...
  void SetOwner(Owner && owner) noexcept  { m_owner = std::move(owner); }
  ...
  friend void Contact(IGameObject & obj, Bullet & bullet, UnitType unitType) { Contact(bullet, obj, unitType); }
